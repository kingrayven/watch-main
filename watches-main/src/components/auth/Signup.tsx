    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (errorData.missingFields) {
          const serverErrors = Object.keys(errorData.missingFields).reduce((acc, field) => {
            if (errorData.missingFields[field]) {
    ...
    <div className="auth-page">
      <div className="auth-container">
        <div className="auth-header">
          ...
          <p className="auth-subtitle">Register to access the delivery management dashboard</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="registration-form" encType="multipart/form-data">
          ...
          <div className="form-footer">
            <button 
              type="submit" 
              className={`auth-button ${isLoading ? 'opacity-75 cursor-not-allowed' : ''}`}
              disabled={isLoading}
            >
              {isLoading ? (
                <>
